defmodule BimipLog do
 ...
 def get_atomic_write_state(user, partition_id) do
  ...
  defp lookup_sparse_index(user, partition_id, _target_offset), do: {0, 1, 0} # Simplified for now
...
# # ACK messages
# BimipLog.ack_status("a@domain.com_b@domain.com", "aaaaa1", 1, 1, :sent)
# BimipLog.ack_status("a@domain.com_b@domain.com", "aaaaa1", 1, 2, :delivered)
# BimipLog.ack_status("a@domain.com_b@domain.com", "aaaaa1", 1, 3, :read)

# # Check message status
# BimipLog.message_status("a@domain.com_b@domain.com", "aaaaa1", 1, 1)