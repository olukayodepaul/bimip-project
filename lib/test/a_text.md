log_path = "data/bimip/shard_14_1768111857.log"
...
log_path = "data/bimip/shard_14_1768112455.log"
...
idx_path = "data/bimip/shard_14_1768111857.idx"

case File.read(idx_path) do
  {:ok, binary} ->
    # Each entry: ulen(16), user(ulen), p(32), off(64), phys_pos(64)
    parse_idx = fn
      recursive, <<ulen::16, user::binary-size(ulen), p::32, off::64, phys::64, rest::binary>> ->
        IO.puts "📍 LOGICAL OFF: #{off}  --->  PHYSICAL POSITION: #{phys} bytes"
